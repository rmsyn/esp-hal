...
//!
//! - SPI CLK (GPIO6, pin 5, pad 6) => SDIO CLK (GPIO19, pin 19, pad 19)
//! - SPI CS0 (GPIO16, pin 2, pad TX) => SDIO CS (GPIO23, pin 23, pad 23)
//! - SPI MOSI (GPIO7, pin 6, pad 7) => SDIO MOSI (GPIO18, pin 18, pad 18)
//! - SPI MISO (GPIO2, pin 12, pad 2) => SDIO MISO (GPIO20, pin 20, pad 20)
